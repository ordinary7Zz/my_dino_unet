python shap_single_image_seg.py \
  --checkpoint /mnt/wangbd8//mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/train_Lymph_Node_Metastasis/dino_unet_Lymph_Node_Metastasis_epoch_40.pth \
