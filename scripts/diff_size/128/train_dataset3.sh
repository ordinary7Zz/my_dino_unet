...
METHOD="dino_unet"
TRAIN_IMAGE_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_experiment/dataset_3/images/"
TRAIN_MASK_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_experiment/dataset_3/masks/"
EPOCH=50
LR=0.0001
BATCH_SIZE=12
CHECKPOINT_DIR="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/diff_size/$IMAGE_SIZE"
CHECKPOINT_INTERVAL=5
EVAL_INTERVAL=5
DATASET_NAME="${IMAGE_SIZE}size_train_dataset_3"
