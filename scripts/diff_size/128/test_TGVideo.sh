...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/diff_size/448/diff_size_train_TGVideo/20251226_102036/dino_unet_diff_size_train_TGVideo_epoch_50.pth"
...
SAVE_PATH="./predictions/test_TGVideo"

# Whether to save prediction results (true/false)
SAVE_RESULTS="false"

# Log directory
LOG_DIR="./logs/test_logs/diff_size/$IMG_SIZE/test_TGVideo"
