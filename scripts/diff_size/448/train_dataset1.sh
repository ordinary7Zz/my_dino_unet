...
METHOD="dino_unet"
TRAIN_IMAGE_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_experiment/dataset_1/images/"
TRAIN_MASK_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_experiment/dataset_1/masks/"
EPOCH=50
LR=0.0001
BATCH_SIZE=12
IMAGE_SIZE=448
...
EVAL_INTERVAL=5
DATASET_NAME="${IMAGE_SIZE}size_train_dataset_1"
