...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/diff_size/448/diff_size_train_dataset_4/20251224_230253/dino_unet_diff_size_train_dataset_4_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/diff_size/448/test_dataset4"
