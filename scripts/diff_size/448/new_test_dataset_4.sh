...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/diff_size/dino_unet_${IMG_SIZE}size_train_${Train_DATASET}_epoch_50.pth"
...
SAVE_PATH="./predictions/diff_size/$IMG_SIZE/new_test_${Train_DATASET}"

# Whether to save prediction results (true/false)
SAVE_RESULTS="false"

# Log directory
LOG_DIR="./logs/test_logs/diff_size/$IMG_SIZE/new_test_${Train_DATASET}"
