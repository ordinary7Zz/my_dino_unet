...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/Segmentation_Agent/weights/${Train_DATASET}/dino_unet_train_${Train_DATASET}_epoch_40.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/test_${Train_DATASET}"
