...
OUTPUT_ROOT="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/screening_inference_outputs/test_dataset_FTCPTC_0"
...
PATIENT_FILTER_JSON="my_json/test_labels_ftcptc_0_filenames.json"
