...
# 设置训练参数
Train_DATASET="train_Lymph_Node_Metastasis"
...
LR=0.0001
BATCH_SIZE=12
CHECKPOINT_DIR="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/train_Lymph_Node_Metastasis"
CHECKPOINT_INTERVAL=5
EVAL_INTERVAL=5
DATASET_NAME="Lymph_Node_Metastasis"
