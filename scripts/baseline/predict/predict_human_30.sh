...
# 测试图像路径数组
TEST_IMAGE_PATHS=(
    "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/human_seg_30/images/"
)

# 测试掩码路径数组
TEST_MASK_PATHS=(
    "/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/human_seg_30/gt/"
)
...
SAVE_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/human_seg_30/masks"
