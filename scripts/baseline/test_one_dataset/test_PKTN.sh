...
# ---------------------- Configuration ----------------------
Train_DATASET="PKTN_comprehensive"
# Set CUDA device
...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/Segmentation_Agent/weights/${Train_DATASET}/dino_unet_train_${Train_DATASET}_epoch_50.pth"
...
SAVE_PATH="./predictions/new_test_${Train_DATASET}"
