...
TEST_DATASET_NAMES=(
    "new_train_Meta_predictions"
    "new_train_NonMeta_predictions"
)

# 测试图像路径数组
TEST_IMAGE_PATHS=(
    "/mnt/wangbd8/workspace/ThyroidAgent/LLNM-Net/dataset_processed/new_train/train_Meta/"
    "/mnt/wangbd8/workspace/ThyroidAgent/LLNM-Net/dataset_processed/new_train/train_NonMeta/"
)
...
SAVE_PATH="/mnt/wangbd8/workspace/ThyroidAgent/LLNM-Net/dataset_processed/"
...
# Log directory
LOG_DIR="/mnt/wangbd8/workspace/ThyroidAgent/LLNM-Net/dataset_processed/"
