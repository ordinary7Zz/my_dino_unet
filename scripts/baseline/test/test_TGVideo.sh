...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/baseline/train_TGVideo/20251210_093328/dino_unet_train_TGVideo_epoch_10.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/baseline/test_TGVideo"
