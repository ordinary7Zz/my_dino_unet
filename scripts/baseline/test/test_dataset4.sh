...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_ori/checkpoints/nopretrained/nopretrained_train_dataset_4/20260108_234341/dino_unet_nopretrained_train_dataset_4_epoch_50.pth"
...
SAVE_PATH="./predictions/test_dataset4/baseline/"
