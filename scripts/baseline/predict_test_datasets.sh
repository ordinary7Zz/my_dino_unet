...
SAVE_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/pred_test_masks/"
...
# Log directory
LOG_DIR="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/pred_test_masks/"
